...
const AboutPage = () => {
    return (
        <div>
            <Header />
            <h1 style={{ textAlign: 'center' }}>About Vivekanand College</h1>
            <p>
                Vivekanand College stands as a beacon of knowledge and integrity, committed to delivering transformative education since its inception in 1980. Located in the bustling heart of Chembur, Mumbai, our college has consistently strived to uphold the highest standards of academic rigor and ethical values.
            </p>
            <p>
            ...
            <h2>Our History</h2>
            <p>
                Our journey began with a vision to make quality education available to all, and we continue that legacy today. From humble beginnings, the college has grown into a respected institution known for academic excellence and distinguished alumni.
            </p>
        </div>
    );
};
