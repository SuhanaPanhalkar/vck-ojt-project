                ...
                <div className="main-box"> {/* Uses shared class */}
                    ...
                    <p> Your journey to excellence starts from here</p> */}
                        ...
                        <div className="campus-images-container">
                            <img src="\Images\cours.jpeg"alt="Vivekanand College Information" className="campus-image"/>
                            <img src="\Images\campus.jpg" alt="Vivekanand College Campus" className="campus-image"/>
                        </div>
                    </div>
                </div>
            </div>
