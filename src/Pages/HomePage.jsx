...
const HomePage =() =>{
    return(
        <div>
            <Header/>
            <center>
                <img src="\Images\college-banner.png" alt="vivekanand college" width="700"/>
                ...
                <p>Your journey to excellence starts here</p>
                    ...
                    <hr/>
                    <img src="\Images\cours.jpeg" alt="Student Studiying" width="400" />
                    <img src="\Images\campus.jpg" alt="Campus life" width="600" />
